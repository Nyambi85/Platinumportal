...
<!-- Mirrored from htmlstream.com/preview/unify-v1.9.5/One-Pages/Classic/one_page_home3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Aug 2016 06:11:42 GMT -->
<head>
    ...
    <!-- Web Fonts -->
    <link rel='stylesheet' type='text/css' href='../../../../../fonts.googleapis.com/css0bd2.css?family=Open+Sans:400,300,600&amp;subset=cyrillic,latin'>
    ...
    <!-- CSS Footer -->
    <link rel="stylesheet" href="{{URL::asset('assets/css/footers/footer-v7.css')}}">
    ...
    <link rel="stylesheet" href="{{URL::asset('assets/css/theme-skins/one.dark.css')}}">
        ...
        <div class="fullscreenbanner">
            <ul>
                ...
                <li data-transition="curtain-1" data-slotamount="5" data-masterspeed="700" data-title="Slide 1">
                    <!-- MAIN IMAGE -->
                    <img src="assets/img/test4.jpg" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
...
<section id="about" class="about-section section-first">
    ...
    <div class="about-image bg-grey">
        <div class="container">
            ...
            <div class="img-center">
                <img class="img-responsive" src="assets/img/mockup/mockup.html" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="container content-lg">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <img class="img-responsive" src="assets/img/mockup/mockup1.html" alt="">
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <ul class="list-unstyled row">
                ...
                <li class="col-sm-3 col-xs-6">
                    <div class="team-img">
                        <img class="img-responsive" src="assets/img/team/img3-md.html" alt="">
                        <ul>
                            <li><a href="#"><i class="icon-custom icon-sm rounded-x fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="icon-custom icon-sm rounded-x fa fa-facebook"></i></a></li>
                            <li><a href="#"><i class="icon-custom icon-sm rounded-x fa fa-google-plus"></i></a></li>
                ...
                <li class="col-sm-3 col-xs-6">
                    <div class="team-img">
                        <img class="img-responsive" src="assets/img/team/img5-md.html" alt="">
                        <ul>
                            <li><a href="#"><i class="icon-custom icon-sm rounded-x fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="icon-custom icon-sm rounded-x fa fa-facebook"></i></a></li>
                            <li><a href="#"><i class="icon-custom icon-sm rounded-x fa fa-google-plus"></i></a></li>
...
<section id="services">
    ...
    <ul class="list-unstyled row portfolio-box-v1">
        <li class="col-sm-4">
            <img class="img-responsive" src="assets/img/mockup/img1.html" alt="">
        ...
        <li class="col-sm-4">
            <img class="img-responsive" src="assets/img/mockup/img2.html" alt="">
            <div class="portfolio-box-v1-in">
                <h3>Ahola Company</h3>
                <p>Brand Design, UI</p>
                <a class="btn-u btn-u-sm btn-brd btn-brd-hover btn-u-light" href="#">Read More</a>
        ...
        <li class="col-sm-4">
            <img class="img-responsive" src="assets/img/mockup/img4.html" alt="">
            <div class="portfolio-box-v1-in">
                <h3>Allan Project</h3>
        ...
        <div class="row news-v1">
            <div class="col-md-4 md-margin-bottom-40">
                <div class="news-v1-in">
                    <img class="img-responsive" src="assets/img/contents/img1.html" alt="">
            ...
            <div class="col-md-4 md-margin-bottom-40">
                <div class="news-v1-in">
                    <img class="img-responsive" src="assets/img/contents/img4.html" alt="">
            ...
            <div class="col-md-4">
                <div class="news-v1-in">
                    <img class="img-responsive" src="assets/img/contents/img3.html" alt="">
                    <h3><a href="#">Focused on helping our clients to build a successful business</a></h3>
                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores.</p>
                    <ul class="list-inline news-v1-info">
                    ...
                    <a href="assets/ajax/project1.html" class="cbp-caption cbp-singlePageInline"
                       data-title="World Clock Widget<br>by Paul Flavius Nechita">
                        <div class="cbp-caption-defaultWrap">
                            <img src="assets/img/portfolio/1.html" alt="">
                        </div>
                ...
                <div class="cbp-item web-design">
                    <a href="assets/ajax/project2.html" class="cbp-caption cbp-singlePageInline"
                       data-title="Bolt UI<br>by Tiberiu Neamu">
                        <div class="cbp-caption-defaultWrap">
                            <img src="assets/img/portfolio/2.html" alt="">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignLeft">
                                <div class="cbp-l-caption-body">
                ...
                <div class="cbp-item print motion">
                    <a href="assets/ajax/project3.html" class="cbp-caption cbp-singlePageInline"
                       data-title="WhereTO App<br>by Tiberiu Neamu">
                        <div class="cbp-caption-defaultWrap">
                            <img src="assets/img/portfolio/3.html" alt="">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignLeft">
                                <div class="cbp-l-caption-body">
                ...
                <div class="cbp-item web-design print">
                    <a href="assets/ajax/project4.html" class="cbp-caption cbp-singlePageInline"
                       data-title="iDevices<br>by Tiberiu Neamu">
                        <div class="cbp-caption-defaultWrap">
                            <img src="assets/img/portfolio/11.html" alt="">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignLeft">
                                <div class="cbp-l-caption-body">
                ...
                <div class="cbp-item motion">
                    <a href="assets/ajax/project5.html" class="cbp-caption cbp-singlePageInline"
                       data-title="Seemple* Music for iPad<br>by Tiberiu Neamu">
                        <div class="cbp-caption-defaultWrap">
                            <img src="assets/img/portfolio/5.html" alt="">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignLeft">
                                <div class="cbp-l-caption-body">
                ...
                <div class="cbp-item print motion">
                    <a href="assets/ajax/project6.html" class="cbp-caption cbp-singlePageInline"
                       data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                        <div class="cbp-caption-defaultWrap">
                            <img src="assets/img/portfolio/6.html" alt="">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignLeft">
                                <div class="cbp-l-caption-body">
                ...
                <div class="cbp-item web-design print">
                    <a href="assets/ajax/project7.html" class="cbp-caption cbp-singlePageInline"
                       data-title="Workout Buddy<br>by Tiberiu Neamu">
                        <div class="cbp-caption-defaultWrap">
                            <img src="assets/img/portfolio/7.html" alt="">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignLeft">
                                <div class="cbp-l-caption-body">
                ...
                <div class="cbp-item print">
                    <a href="assets/ajax/project8.html" class="cbp-caption cbp-singlePageInline"
                       data-title="Digital Menu<br>by Cosmin Capitanu">
                        <div class="cbp-caption-defaultWrap">
                            <img src="assets/img/portfolio/8.html" alt="">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignLeft">
                                <div class="cbp-l-caption-body">
                ...
                <div class="cbp-item motion">
                    <a href="assets/ajax/project9.html" class="cbp-caption cbp-singlePageInline"
                       data-title="Holiday Selector<br>by Cosmin Capitanu">
                        <div class="cbp-caption-defaultWrap">
                            <img src="assets/img/portfolio/4.html" alt="">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignLeft">
                                <div class="cbp-l-caption-body">
    ...
    <div class="clients-section parallaxBg">
        <div class="container">
            ...
            <ul class="owl-clients-v2">
                <li class="item"><a href="#"><img src="assets/img/clients/national-geographic.html" alt=""></a></li>
                <li class="item"><a href="#"><img src="assets/img/clients/inspiring.html" alt=""></a></li>
                <li class="item"><a href="#"><img src="assets/img/clients/fred-perry.html" alt=""></a></li>
                <li class="item"><a href="#"><img src="assets/img/clients/emirates.html" alt=""></a></li>
                <li class="item"><a href="#"><img src="assets/img/clients/baderbrau.html" alt=""></a></li>
                <li class="item"><a href="#"><img src="assets/img/clients/inspiring.html" alt=""></a></li>
            </ul>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <ul class="list-unstyled owl-ts-v1">
                        <li class="item">
                            <img class="rounded-x img-bordered" src="assets/img/team/img3-sm.html" alt="">
                        ...
                        <li class="item">
                            <img class="rounded-x img-bordered" src="assets/img/team/img2-sm.html" alt="">
                            <div class="testimonials-v3-title">
                                <p>Tina Krueger</p>
                        ...
                        <li class="item">
                            <img class="rounded-x img-bordered" src="assets/img/team/img1-sm.html" alt="">
                            <div class="testimonials-v3-title">
                                <p>John Clarck</p>
        ...
        <div class="row contacts-in">
            <div class="col-md-6 md-margin-bottom-40">
                <ul class="list-unstyled">
                    ...
                    <li><i class="fa fa-envelope"></i> <a href="info%40example.com">info@example.com</a></li>
                    <li><i class="fa fa-globe"></i> <a href="http://htmlstream.com/">www.htmlstream.com</a></li>
                </ul>
            </div>

            <div class="col-md-6">
                <form action="http://htmlstream.com/preview/unify-v1.9.5/One-Pages/Classic/assets/php/sky-forms-pro/demo-contacts-process.php" method="post" id="sky-form3" class="sky-form contact-style">
                    <fieldset>
                        <label>Name</label>
                        <div class="row">
