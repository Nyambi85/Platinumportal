...
<head>
    ...
    <!-- CSS Global Compulsory -->
    <link rel="stylesheet" href="{{URL::asset('assets/plugins/bootstrap/css/bootstrap-rtl.min.css')}}">
    <link rel="stylesheet" href="{{URL::asset('assets/css/css-rtl/style-rtl.css')}}">

    <!-- CSS Header and Footer -->
    <link rel="stylesheet" href="{{URL::asset('assets/css/css-rtl/headers/header-default-rtl.css')}}">
    <link rel="stylesheet" href="{{URL::asset('assets/css/css-rtl/footers/footer-v1-rtl.css')}}">
    ...
    <link rel="stylesheet" href="{{URL::asset('assets/plugins/owl-carousel2/assets/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{URL::asset('assets/plugins/sky-forms-pro/skyforms/css/sky-forms-rtl.css')}}">
    <link rel="stylesheet" href="{{URL::asset('assets/plugins/sky-forms-pro/skyforms/custom/custom-sky-forms-rtl.css')}}">
    <!--[if lt IE 9]><link rel="stylesheet" href="{{URL::asset('assets/plugins/sky-forms-pro/skyforms/css/sky-forms-ie8.css')}}"><![endif]-->

    <!-- CSS Page Style -->
    <link rel="stylesheet" href="{{URL::asset('assets/css/css-rtl/pages/page_search-rtl.css')}}">

    <!-- Style Switcher -->
    <link rel="stylesheet" href="{{URL::asset('assets/css/plugins/style-switcher.css')}}">

    <!-- CSS Theme -->
    <link rel="stylesheet" href=".{{URL::asset('assets/css/css-rtl/theme-colors/default.css')}}" id="style_color">
    <link rel="stylesheet" href="{{URL::asset('assets/css/css-rtl/theme-skins/dark.css')}}">

    <!-- RTL Customization -->
    <link rel="stylesheet" href="{{URL::asset('assets/css/css-rtl/rtl.css')}}">
            ...
            <div class="clearfix margin-bottom-100">
                ...
                <div class="blog margin-bottom-40">
                     ...
                     <div class=" input-group margin-bottom-20 " >
                           <h3>Kindly Click <a href="{{$path}}" style="color:#00008B">here </a> to proceed for Aptitude test </h3>
                       </div>
