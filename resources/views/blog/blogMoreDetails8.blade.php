                        ...
                        <div class="carousel slide carousel-v2" id="portfolio-carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="img-responsive full-width" src="assets/img/11.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="img-responsive full-width" src="assets/img/44.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="img-responsive full-width" src="assets/img/33.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="img-responsive full-width" src="assets/img/55.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="img-responsive full-width" src="assets/img/66.jpg" alt="">
                                </div>
                            </div>
